...
import { Gauge, Workflow, ChartColumnStacked, DatabaseZap, Users, Settings, LifeBuoy, BookOpenText } from "lucide-react";
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton size="lg">
                ...
                <span className="font-extrabold lg:text-xl">Acme Corp</span>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
        </SidebarHeader>
